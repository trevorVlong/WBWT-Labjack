    ...
    %% setup up channels
        ...
        function obj = SetDIOCounter(obj)
            ...
            try:
                ...
                LabJack.LJM.eWriteName(obj.handle,sprintf('DIO1_EF_ENABLE'),1)
                obj.DIOInChannels = [DIOInChannels, 'DIO1']
            catch e 
                disp(e)
            end
        ...
        function obj = configureStreamBurst(obj,scan_rate)
            ...
            for idx = 1:obj.numIN:
                obj.ScanListNames(idx) = obj.channelIn(idx)
            end
            ...
            Labjack.LJM.eWriteName('STREAM_RESOLUTION_INDEX',7)
        end
